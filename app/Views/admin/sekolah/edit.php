...
<div class="pg-wrap">
    ...
    <div class="pg-header">
        <div>
            ...
            <h1 class="pg-title">Edit Sekolah</h1>
            <p class="pg-sub">Perbarui data sekolah <strong><?= esc($sekolah['nama_sekolah']) ?></strong>.</p>
        </div>
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form action="<?= base_url('admin/sekolah/edit/' . $sekolah['sekolah_id']) ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="f-input" id="alamat" name="alamat"
                              rows="3" placeholder="Masukkan alamat lengkap sekolah"><?= old('alamat', $sekolah['alamat']) ?></textarea>
                </div>
            </div>
