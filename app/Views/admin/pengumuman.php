              ...
              <div class="d-flex align-items-start justify-content-between mb-3">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item text-danger" href="<?= base_url('admin/pengumuman/hapus/' . $p['pengumuman_id']) ?>"
  ...
  <div class="modal fade" id="editPengumumanModal<?= $p['pengumuman_id'] ?>" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="<?= base_url('admin/pengumuman/edit/' . $p['pengumuman_id']) ?>" method="post">
          <div class="modal-body">
            <div class="row g-3">
              <div class="col-12">
                <label class="form-label fw-semibold">Judul</label>
