    ...
    <div class="pg-header">
        <div>
            <div class="pg-breadcrumb">
                ...
                <span class="pg-bc-active"><?= $kategori === 'umum' ? 'Bank Soal Umum' : 'Kelas ' . esc($kategori) ?></span>
            </div>
            <p class="pg-eyebrow" style="margin-top:.5rem">Bank Soal</p>
            <h1 class="pg-title">
                <?= $kategori === 'umum' ? 'Bank Soal Umum' : 'Bank Soal Kelas ' . esc($kategori) ?>
            </h1>
            <p class="pg-sub">Mata pelajaran yang tersedia dalam kategori ini.</p>
        </div>
        <a href="<?= base_url('admin/bank-soal') ?>" class="btn-back"><i class="bi bi-arrow-left"></i> Kembali</a>
    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="kat-card">
                        <div class="kat-card-top">
                            ...
                            <div class="ms-auto dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="border-radius:10px;font-size:.85rem">
                                    <li>
                                        <a class="dropdown-item" href="<?= base_url('admin/bank-soal/kategori/' . urlencode($kategori) . '/jenis-ujian/' . $jenis['jenis_ujian_id']) ?>">
                                            <i class="bi bi-arrow-right me-2"></i>Lihat Bank Ujian
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="kat-card-body">
                            ...
                            <p class="kat-count">
                                <span class="pg-badge"><?= $jenis['jumlah_ujian'] ?> Bank Ujian</span>
                            </p>
                        </div>
                        <div class="kat-card-footer">
                            <a href="<?= base_url('admin/bank-soal/kategori/' . urlencode($kategori) . '/jenis-ujian/' . $jenis['jenis_ujian_id']) ?>" class="kat-link">
                                Lihat Bank Ujian <i class="bi bi-arrow-right ms-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="tbl-card">
                    <div class="tbl-empty">
                        ...
                        <p>Belum ada mata pelajaran untuk kategori "<?= esc($kategori) ?>"</p>
...
.pg-breadcrumb{display:flex;align-items:center;gap:6px;font-size:.8rem;margin-bottom:.25rem}
...
.kat-title{font-size:1rem;font-weight:700;color:#0f172a;margin-bottom:6px}
.kat-count{margin:0}
