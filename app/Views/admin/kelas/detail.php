        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('admin/sekolah/' . $kelas['sekolah_id'] . '/kelas') ?>"><?= esc($kelas['nama_sekolah']) ?></a></li>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="btn-group">
                    <a href="<?= base_url('admin/kelas/edit/' . $kelas['kelas_id']) ?>" class="btn btn-outline-primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <a href="<?= base_url('admin/kelas/' . $kelas['kelas_id'] . '/guru/remove/' . $guru['guru_id']) ?>" 
                ...
                <div class="tab-pane fade" id="siswa" role="tabpanel">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                <a href="<?= base_url('admin/siswa')?>" class="btn btn-sm btn-success">
                                        ...
                                        <?php if (empty($daftarSiswa)): ?>
                                            <tr>
                                                <td colspan="6" class="text-center py-4">
                                                    ...
                                                    <a href="<?= base_url('admin/siswa') ?>" class="btn btn-outline-success">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <a href="<?= base_url('admin/kelas/' . $kelas['kelas_id'] . '/siswa/remove/' . $siswa['siswa_id']) ?>" 
                                                               class="btn btn-sm btn-outline-warning" 
                                                               title="Pindah dari Kelas"
                                                               onclick="return confirm('Yakin ingin memindahkan <?= esc($siswa['nama_lengkap']) ?> dari kelas ini?')">
...
<div class="modal fade" id="tambah-guru" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('admin/kelas/' . $kelas['kelas_id'] . '/guru/assign') ?>" method="POST">
                <?= csrf_field() ?>
