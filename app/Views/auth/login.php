        ...
        <div class="auth-left-content">
            ...
            <div class="auth-features">
                <div class="auth-feature-item">
                    <div class="auth-feature-icon"><i class="bi bi-cpu-fill"></i></div>
                    <span>Algoritma CAT Adaptif</span>
                </div>
                <div class="auth-feature-item">
                    <div class="auth-feature-icon"><i class="bi bi-lightbulb-fill"></i></div>
                    <span>Ukur Kemampuan Berpikir Kritis</span>
                </div>
                <div class="auth-feature-item">
    ...
    <div class="auth-right-panel">
        <div class="auth-card">
            ...
            <form action="<?= base_url('login') ?>" method="post" class="auth-form" autocomplete="on">
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-wrap auth-input-password">
                        <input type="password" class="auth-input" name="password" id="passwordInput" placeholder="Masukkan password Anda" autocomplete="current-password" readonly required>
                        <button type="button" class="btn-toggle-pass" onclick="togglePassword('passwordInput', 'togglePassIcon')">
            ...
            <div class="auth-footer-text">
                Belum punya akun? <a href="<?= base_url('register') ?>" class="auth-link">Daftar sekarang</a>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    .auth-input-password:focus-within .btn-toggle-pass {
        border-color: #0051ba;
        background: white;
    }
