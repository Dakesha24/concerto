...
<script>
  ...
  function loadKategori() {
    ...
    $.ajax({
      url: '<?= base_url('guru/bank-soal/api/kategori') ?>',
      type: 'GET',
      dataType: 'json',
      timeout: 10000,
  ...
  function onKategoriChange() {
    ...
    $.ajax({
      url: `<?= base_url('guru/bank-soal/api/jenis-ujian') ?>?kategori=${encodeURIComponent(kategori)}`,
      type: 'GET',
      dataType: 'json',
      timeout: 10000,
      success: function(data) {
  ...
  function onJenisUjianChange() {
    ...
    $.ajax({
      url: `<?= base_url('guru/bank-soal/api/bank-ujian') ?>?kategori=${encodeURIComponent(kategori)}&jenis_ujian_id=${jenisUjianId}`,
      type: 'GET',
      dataType: 'json',
      timeout: 10000,
      success: function(data) {
  ...
  function onBankUjianChange() {
    ...
    $.ajax({
      url: `<?= base_url('guru/bank-soal/api/soal') ?>?bank_ujian_id=${bankUjianId}`,
      type: 'GET',
      dataType: 'json',
      timeout: 15000,
      success: function(data) {
